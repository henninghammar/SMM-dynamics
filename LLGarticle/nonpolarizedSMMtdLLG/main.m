...
for j=1:length(t)
    ...
    for i=1:tback+1
        ...
        [G0less(i), G0great(i), G1xless(i), G1xgreat(i), G1yless(i), G1ygreat(i), G1zless(i), G1zgreat(i)] = SMMnonpolarizedgreensfunction(t(j), tau(i), t0, t1, epsilon, g0tot, g0, mu, w, fermi, S, J);

        %Green's function of (tau,t) for each timestep tau with integration over energies w/omega
        [G0less2(i), G0great2(i), G1xless2(i), G1xgreat2(i), G1yless2(i), G1ygreat2(i), G1zless2(i), G1zgreat2(i)]= SMMnonpolarizedgreensfunction(tau(i), t(j), t0, t1, epsilon, g0tot, g0, mu, w, fermi, S, J);
    ...
    [mx, my, mz] = degenerateQDmagneticoccupation(t(j), t0, t1, epsilon, g0tot, g0, mu, w, fermi, S, J);

    %Calculate the effective fields
    effectivefields

    %Spin equation of motion
    [dSx1, dSy1, dSz1] = spinequationofmotiontdLLG(Beffx, Beffy, Beffz,jH,jDMx,jDMy,jDMz,jIxx,jIyy,jIzz,jIxy,jIyx,jIxz,jIzx,jIyz,jIzy, S, dS, tau, t(j));
    ...
    for i=1:tback+1
        ...
        %Green's function of (t,tau) for each timestep tau with integration over energies w/omega
        [G0less(i), G0great(i), G1xless(i), G1xgreat(i), G1yless(i), G1ygreat(i), G1zless(i), G1zgreat(i)] = SMMnonpolarizedgreensfunction(t(j), tau(i), t0, t1, epsilon, g0tot, g0, mu, w, fermi, S2, J);

        %Green's function of (tau, t) for each timestep tau with integration over energies w/omega
        [G0less2(i), G0great2(i), G1xless2(i), G1xgreat2(i), G1yless2(i), G1ygreat2(i), G1zless2(i), G1zgreat2(i)]= SMMnonpolarizedgreensfunction(tau(i), t(j), t0, t1, epsilon, g0tot, g0, mu, w, fermi, S2, J);
    ...
    [mx, my, mz] = degenerateQDmagneticoccupation(t(j), t0, t1, epsilon, g0tot, g0, mu, w, fermi, S2, J);

    effectivefields

    %Spin equation of motion
    [dSx2, dSy2, dSz2] = spinequationofmotiontdLLG(Beffx, Beffy, Beffz,jH,jDMx,jDMy,jDMz,jIxx,jIyy,jIzz,jIxy,jIyx,jIxz,jIzx,jIyz,jIzy, S2, dS1, tau, t(j));
