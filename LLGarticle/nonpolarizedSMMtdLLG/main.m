...
for j=1:length(t)
    ...
    [mx, my, mz] = degenerateQDmagneticoccupation(t(j), t0, t1, epsilon, g0tot, g0, eV, w, fermi, S, J);
    ...
    [mx, my, mz] = degenerateQDmagneticoccupation(t(j), t0, t1, epsilon, g0tot, g0, eV, w, fermi, S2, J);
